...
$.extend( $.validator, {
	...
	messages: {
		...
		dateISO: "Ingrese una fecha valida en formato ( ISO ).",
		number: "Ingrese solo numeros.",
		digits: "Ingrese solo digitos.",
		creditcard: "Ingrese un numero de targeta de credito valido.",
		equalTo: "La informacion digitada no es igual a la anterior.",
		maxlength: $.validator.format( "Maximo de {0} caracteres excedido." ),
		minlength: $.validator.format( "Minimo de {0} caracteres no alcanzado." ),
